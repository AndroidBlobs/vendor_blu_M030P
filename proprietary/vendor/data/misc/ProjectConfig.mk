...
CUSTOM_MODEM = x6335_g4_w1258_hspa
...
# WTK Begin For Driver-----------------------
# LCM
BOOT_LOGO = x6335_blu_walmart_80_o1_go_fwvgaplus
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
...
# CAMERA:=============
CUSTOM_HAL_IMGSENSOR = gc5025_mipi_raw gc23850_mipi_raw gc8034_mipi_raw gc50250_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = gc5025_mipi_raw gc8034_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = gc23850_mipi_raw gc50250_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =

CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw gc23850_mipi_raw gc8034_mipi_raw gc50250_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025_mipi_raw gc8034_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_SUB_IMGSENSOR = gc23850_mipi_raw gc50250_mipi_raw
...
WTK_BUILD_VERNO = BLU_M030P_V8.1.G.03.04_GENERIC
WTK_INTERNAL_BUILD_VERNO = X6335_BLU_WALMART_80_O1_GO_V0.3.1.2_S0507

#add by gaoshan 20180108 start
WTK_FINGERPRINT_HARDWARE_SUPPORT = no
FINGERPRINT_MICROARRAY_A118_REE = no
#add by gaoshan 20180108 end


# A: Bug_id:add WtkFileManager chenchunyong 20171101 {
WTK_FILEMANAGER_APP = no
# A: }

# A: Bug_id:add WtkFlashlight chenchunyong 20180121 {
WTK_FLASHLIGHT_SUPPORT = no
# A: }

#add by gaoshan 20180122 start
WTK_MTP_LABEL = M6
WTK_PTP_LABEL = M6
WTK_INTERNAL_SD_LABEL = M6
#add by gaoshan 20180122 end

#add by gaoshan 20180305 start
WTK_OTA_DIFF_PACKAGE_SUPPORT = yes
#add by gaoshan 20180305 end

WTK_GMAIL_WITHOUT_EMAIL = yes
WTK_PHOTOS_OVERRIDES_GALLERY2 = yes

# A: Bug_id:add WtkCamera chenchunyong 20180201 {
WTK_CAMERA_SUPPORT = yes
# A: }

# A: Bug_id:add SoundRecorder chenchunyong 20180207 {
MTK_SOUNDRECORDER_APP = yes
# A: }

# Add for XLSSS-275 begin
WTK_PART_NUMBER = M030P
# Add for XLSSS-275 end

#add by wangjian for blu oobe 20180507 start
#GN3RD_BLU_SUPPORT = yes
#add by wangjian for blu oobe 20180507 end

#add by liulei for XLSSS-320 20180513 start
WTK_CTS_ACC_SUPPORT = yes
#add by liulei for XLSSS-320 20180513 end

# Add Screen cornner design begin
WTK_SCREEN_CORNER_SUPPORT = yes
# Add Screen cornner design end

#add PAI blu gang.liu start
BLU_PAI_SUPPORT = yes
#add PAI blu gang.liu end

#End For Common------------------------------------------------------------}

#add by jinhui.li XLSSS-532 start
#PLATFORM_BASE_OS = BLU/Studio_G4/S870Q:8.1.0/O11019/1531454525:user/release-keys
#add by jinhui.li XLSSS-532 end

#A:YWLL-30 jinhui.li {
WTK_CUSTOM_ECC_LIST = yes
#A:YWLL-30 }
